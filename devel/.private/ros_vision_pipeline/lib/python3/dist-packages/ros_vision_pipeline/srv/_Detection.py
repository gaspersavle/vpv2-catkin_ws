...
"""autogenerated by genpy from ros_vision_pipeline/DetectionRequest.msg. Do not edit."""
import codecs
import sys
...
class DetectionRequest(genpy.Message):
  ...
  _type = "ros_vision_pipeline/DetectionRequest"
...
def _get_struct_I():
    ...
    return _struct_I
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from ros_vision_pipeline/DetectionResponse.msg. Do not edit."""
import codecs
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
...
class DetectionResponse(genpy.Message):
  _md5sum = "e23fc2624ba0a7cfc8ed0d73a73b6fae"
  _type = "ros_vision_pipeline/DetectionResponse"
  _has_header = False  # flag to mark the presence of a Header object
...
string frame_id
"""
  __slots__ = ['success','image','detections']
  _slot_types = ['bool','sensor_msgs/Image','string']
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_B3I().pack(_x.success, _x.image.header.seq, _x.image.header.stamp.secs, _x.image.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.success, _x.image.header.seq, _x.image.header.stamp.secs, _x.image.header.stamp.nsecs,) = _get_struct_B3I().unpack(str[start:end])
      ...
      if python3:
        self.detections = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.detections = str[start:end]
      return self
    except struct.error as e:
      raise genpy.DeserializationError(e)  # most likely buffer underfill
...
class Detection(object):
  _type          = 'ros_vision_pipeline/Detection'
  _md5sum = 'e23fc2624ba0a7cfc8ed0d73a73b6fae'

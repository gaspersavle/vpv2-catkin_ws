...
;//! \htmlinclude LeverBlock.msg.html

(cl:defclass <LeverBlock> (roslisp-msg-protocol:ros-message)
  ((module
    :reader module
    :initarg :module
    :type cl:fixnum
...
(cl:defclass LeverBlock (<LeverBlock>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <LeverBlock>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'LeverBlock)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name context_action_framework-msg:<LeverBlock> is deprecated: use context_action_framework-msg:LeverBlock instead.")))

(cl:ensure-generic-function 'module-val :lambda-list '(m))
(cl:defmethod module-val ((m <LeverBlock>))
...
(cl:defmethod from_tf-val ((m <LeverBlock>))
...
(cl:defmethod to_tf-val ((m <LeverBlock>))
...
(cl:defmethod obb_3d-val ((m <LeverBlock>))
...
(cl:defmethod robot-val ((m <LeverBlock>))
...
(cl:defmethod end_effector-val ((m <LeverBlock>))
  ...
  (end_effector m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <LeverBlock>) ostream)
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <LeverBlock>) istream)
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<LeverBlock>)))
  "Returns string type for a message object of type '<LeverBlock>"
  "context_action_framework/LeverBlock")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'LeverBlock)))
  "Returns string type for a message object of type 'LeverBlock"
  "context_action_framework/LeverBlock")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<LeverBlock>)))
  "Returns md5sum for a message object of type '<LeverBlock>"
  "362401529df743727529b8dd943b4bb4")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'LeverBlock)))
  "Returns md5sum for a message object of type 'LeverBlock"
  "362401529df743727529b8dd943b4bb4")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<LeverBlock>)))
  "Returns full string definition for message of type '<LeverBlock>"
  (cl:format cl:nil "# Module enum~%int8 module~%~%# transform start of levering~%geometry_msgs/Transform from_tf~%~%# transform end of levering~%geometry_msgs/Transform to_tf~%~%float32[] obb_3d~%~%# Robot enum~%int8 robot~%~%# EndEffector enum~%int8 end_effector~%~%================================================================================~%MSG: geometry_msgs/Transform~%# This represents the transform between two coordinate frames in free space.~%~%Vector3 translation~%Quaternion rotation~%~%================================================================================~%MSG: geometry_msgs/Vector3~%# This represents a vector in free space. ~%# It is only meant to represent a direction. Therefore, it does not~%# make sense to apply a translation to it (e.g., when applying a ~%# generic rigid transformation to a Vector3, tf2 will only apply the~%# rotation). If you want your data to be translatable too, use the~%# geometry_msgs/Point message instead.~%~%float64 x~%float64 y~%float64 z~%================================================================================~%MSG: geometry_msgs/Quaternion~%# This represents an orientation in free space in quaternion form.~%~%float64 x~%float64 y~%float64 z~%float64 w~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'LeverBlock)))
  "Returns full string definition for message of type 'LeverBlock"
  (cl:format cl:nil "# Module enum~%int8 module~%~%# transform start of levering~%geometry_msgs/Transform from_tf~%~%# transform end of levering~%geometry_msgs/Transform to_tf~%~%float32[] obb_3d~%~%# Robot enum~%int8 robot~%~%# EndEffector enum~%int8 end_effector~%~%================================================================================~%MSG: geometry_msgs/Transform~%# This represents the transform between two coordinate frames in free space.~%~%Vector3 translation~%Quaternion rotation~%~%================================================================================~%MSG: geometry_msgs/Vector3~%# This represents a vector in free space. ~%# It is only meant to represent a direction. Therefore, it does not~%# make sense to apply a translation to it (e.g., when applying a ~%# generic rigid transformation to a Vector3, tf2 will only apply the~%# rotation). If you want your data to be translatable too, use the~%# geometry_msgs/Point message instead.~%~%float64 x~%float64 y~%float64 z~%================================================================================~%MSG: geometry_msgs/Quaternion~%# This represents an orientation in free space in quaternion form.~%~%float64 x~%float64 y~%float64 z~%float64 w~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <LeverBlock>))
  (cl:+ 0
     1
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <LeverBlock>))

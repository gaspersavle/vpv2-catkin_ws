...
;//! \htmlinclude CutBlock.msg.html

(cl:defclass <CutBlock> (roslisp-msg-protocol:ros-message)
  ((from_module
    :reader from_module
    :initarg :from_module
    :type cl:fixnum
...
(cl:defclass CutBlock (<CutBlock>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <CutBlock>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'CutBlock)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name context_action_framework-msg:<CutBlock> is deprecated: use context_action_framework-msg:CutBlock instead.")))

(cl:ensure-generic-function 'from_module-val :lambda-list '(m))
(cl:defmethod from_module-val ((m <CutBlock>))
...
(cl:defmethod from_tf-val ((m <CutBlock>))
...
(cl:defmethod to_module-val ((m <CutBlock>))
...
(cl:defmethod to_tf-val ((m <CutBlock>))
...
(cl:defmethod obb_3d-val ((m <CutBlock>))
...
(cl:defmethod robot-val ((m <CutBlock>))
...
(cl:defmethod end_effector-val ((m <CutBlock>))
  ...
  (end_effector m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <CutBlock>) ostream)
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <CutBlock>) istream)
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<CutBlock>)))
  "Returns string type for a message object of type '<CutBlock>"
  "context_action_framework/CutBlock")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'CutBlock)))
  "Returns string type for a message object of type 'CutBlock"
  "context_action_framework/CutBlock")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<CutBlock>)))
  "Returns md5sum for a message object of type '<CutBlock>"
  "9c379bf0439aa211625fd0ca468ffee9")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'CutBlock)))
  "Returns md5sum for a message object of type 'CutBlock"
  "9c379bf0439aa211625fd0ca468ffee9")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<CutBlock>)))
  "Returns full string definition for message of type '<CutBlock>"
  (cl:format cl:nil "# Module enum~%int8 from_module~%~%# move from transform~%geometry_msgs/Transform from_tf~%~%# Module enum~%int8 to_module~%~%# move to transform~%geometry_msgs/Transform to_tf~%~%float32[] obb_3d~%~%# Robot enum~%int8 robot~%~%# EndEffector enum~%int8 end_effector~%~%# todo: specify where to make the cut, including which side to insert into cutter~%    ~%================================================================================~%MSG: geometry_msgs/Transform~%# This represents the transform between two coordinate frames in free space.~%~%Vector3 translation~%Quaternion rotation~%~%================================================================================~%MSG: geometry_msgs/Vector3~%# This represents a vector in free space. ~%# It is only meant to represent a direction. Therefore, it does not~%# make sense to apply a translation to it (e.g., when applying a ~%# generic rigid transformation to a Vector3, tf2 will only apply the~%# rotation). If you want your data to be translatable too, use the~%# geometry_msgs/Point message instead.~%~%float64 x~%float64 y~%float64 z~%================================================================================~%MSG: geometry_msgs/Quaternion~%# This represents an orientation in free space in quaternion form.~%~%float64 x~%float64 y~%float64 z~%float64 w~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'CutBlock)))
  "Returns full string definition for message of type 'CutBlock"
  (cl:format cl:nil "# Module enum~%int8 from_module~%~%# move from transform~%geometry_msgs/Transform from_tf~%~%# Module enum~%int8 to_module~%~%# move to transform~%geometry_msgs/Transform to_tf~%~%float32[] obb_3d~%~%# Robot enum~%int8 robot~%~%# EndEffector enum~%int8 end_effector~%~%# todo: specify where to make the cut, including which side to insert into cutter~%    ~%================================================================================~%MSG: geometry_msgs/Transform~%# This represents the transform between two coordinate frames in free space.~%~%Vector3 translation~%Quaternion rotation~%~%================================================================================~%MSG: geometry_msgs/Vector3~%# This represents a vector in free space. ~%# It is only meant to represent a direction. Therefore, it does not~%# make sense to apply a translation to it (e.g., when applying a ~%# generic rigid transformation to a Vector3, tf2 will only apply the~%# rotation). If you want your data to be translatable too, use the~%# geometry_msgs/Point message instead.~%~%float64 x~%float64 y~%float64 z~%================================================================================~%MSG: geometry_msgs/Quaternion~%# This represents an orientation in free space in quaternion form.~%~%float64 x~%float64 y~%float64 z~%float64 w~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <CutBlock>))
  (cl:+ 0
     1
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <CutBlock>))

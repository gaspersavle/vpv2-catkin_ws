...
class TurnOverDetails {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new TurnOverDetails(null);
  ...
  static datatype() {
    ...
    return 'context_action_framework/TurnOverDetails';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new TurnOverDetails(null);
...
module.exports = TurnOverDetails;

...
class currentParams {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('MaxNumBuffer')) {
        this.MaxNumBuffer = initObj.MaxNumBuffer
      }
      else {
        this.MaxNumBuffer = 0;
      }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Serialize message field [MaxNumBuffer]
    bufferOffset = _serializer.int32(obj.MaxNumBuffer, buffer, bufferOffset);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    // Deserialize message field [MaxNumBuffer]
    data.MaxNumBuffer = _deserializer.int32(buffer, bufferOffset);
  ...
  static Resolve(msg) {
    ...
    if (msg.MaxNumBuffer !== undefined) {
      resolved.MaxNumBuffer = msg.MaxNumBuffer;
    }
    else {
      resolved.MaxNumBuffer = 0
    }

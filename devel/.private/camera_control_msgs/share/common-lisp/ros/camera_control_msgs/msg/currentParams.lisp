...
(cl:ensure-generic-function 'MaxNumBuffer-val :lambda-list '(m))
(cl:defmethod MaxNumBuffer-val ((m <currentParams>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader camera_control_msgs-msg:MaxNumBuffer-val is deprecated.  Use camera_control_msgs-msg:MaxNumBuffer instead.")
  (MaxNumBuffer m))
...
(cl:defmethod temperature-val ((m <currentParams>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader camera_control_msgs-msg:temperature-val is deprecated.  Use camera_control_msgs-msg:temperature instead.")
  (temperature m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <currentParams>) ostream)
  ...
  (cl:let* ((signed (cl:slot-value msg 'MaxNumBuffer)) (unsigned (cl:if (cl:< signed 0) (cl:+ signed 4294967296) signed)))
    (cl:write-byte (cl:ldb (cl:byte 8 0) unsigned) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) unsigned) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) unsigned) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) unsigned) ostream)
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <currentParams>) istream)
  "Deserializes a message object of type '<currentParams>"
    ...
    (cl:let ((unsigned 0))
      ...
      (cl:setf (cl:ldb (cl:byte 8 16) unsigned) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 24) unsigned) (cl:read-byte istream))
      (cl:setf (cl:slot-value msg 'MaxNumBuffer) (cl:if (cl:< unsigned 2147483648) unsigned (cl:- unsigned 4294967296))))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<currentParams>)))
  ...
  "442a674eef3748e9fe89b83004286960")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'currentParams)))
  "Returns md5sum for a message object of type 'currentParams"
  "442a674eef3748e9fe89b83004286960")
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <currentParams>))
  ...
  (cl:list 'currentParams
    ...
    (cl:cons ':MaxNumBuffer (MaxNumBuffer msg))
    (cl:cons ':roi (roi msg))

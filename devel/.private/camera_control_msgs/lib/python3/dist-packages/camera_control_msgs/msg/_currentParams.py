...
class currentParams(genpy.Message):
  _md5sum = "442a674eef3748e9fe89b83004286960"
...
bool do_rectify
"""
  __slots__ = ['offset_x','offset_y','reverse_x','reverse_y','black_level','pgi_mode','demosaicing_mode','noise_reduction','sharpness_enhancement','light_source_preset','balance_white_auto','sensor_readout_mode','acquisition_frame_count','trigger_selector','trigger_mode','trigger_source','trigger_activation','trigger_delay','user_set_selector','user_set_default_selector','is_sleeping','brightness','exposure','gain','gamma','binning_x','binning_y','MaxNumBuffer','roi','available_image_encoding','current_image_encoding','current_image_ros_encoding','sucess','message','temperature']
  _slot_types = ['uint32','uint32','bool','bool','int32','int32','int32','float32','float32','int32','int32','int32','int32','int32','int32','int32','int32','float32','int32','int32','bool','float32','float32','float32','float32','uint32','uint32','int32','sensor_msgs/RegionOfInterest','string[]','string','string','bool','string','float32']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.offset_x, _x.offset_y, _x.reverse_x, _x.reverse_y, _x.black_level, _x.pgi_mode, _x.demosaicing_mode, _x.noise_reduction, _x.sharpness_enhancement, _x.light_source_preset, _x.balance_white_auto, _x.sensor_readout_mode, _x.acquisition_frame_count, _x.trigger_selector, _x.trigger_mode, _x.trigger_source, _x.trigger_activation, _x.trigger_delay, _x.user_set_selector, _x.user_set_default_selector, _x.is_sleeping, _x.brightness, _x.exposure, _x.gain, _x.gamma, _x.binning_x, _x.binning_y, _x.MaxNumBuffer, _x.roi.x_offset, _x.roi.y_offset, _x.roi.height, _x.roi.width, _x.roi.do_rectify,) = _get_struct_2I2B3i2f8if2iB4f2Ii4IB().unpack(str[start:end])
...
def _get_struct_I():
    global _struct_I
    return _struct_I
_struct_2I2B3i2f8if2iB4f2Ii4IB = None
def _get_struct_2I2B3i2f8if2iB4f2Ii4IB():
    global _struct_2I2B3i2f8if2iB4f2Ii4IB
    if _struct_2I2B3i2f8if2iB4f2Ii4IB is None:
        _struct_2I2B3i2f8if2iB4f2Ii4IB = struct.Struct("<2I2B3i2f8if2iB4f2Ii4IB")
    return _struct_2I2B3i2f8if2iB4f2Ii4IB
_struct_B = None
def _get_struct_B():
    global _struct_B
